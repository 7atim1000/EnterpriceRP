        ...
        <div className='bg-white rounded-xl shadow-lg border border-blue-100 p-4 h-full'>
            ...
            <div className='space-y-2 mb-4'>
                <div className='flex justify-between items-center py-2 border-b border-gray-100'>
                    ...
                    <span className='font-medium text-gray-800'>{total.toFixed(2)} OMR</span>
                </div>
                ...
                <div className='flex justify-between items-center py-2 border-b border-gray-100'>
                    ...
                    <span className='font-medium text-gray-800'>{calculations.tax.toFixed(2)} OMR</span>
                </div>
                ...
                <div className='flex justify-between items-center py-3 bg-blue-50 rounded-lg px-3'>
                    ...
                    <span className='text-lg font-bold text-blue-800'>{calculations.totalPriceWithTax.toFixed(2)} OMR</span>
                </div>
            </div>
                    ...
                    <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-2'>
                        ...
                        <div className='relative flex-1 sm:max-w-[180px]'>
                            <input
                                ...
                                placeholder='0.00'
                            />
                            <span className='absolute left-3 top-2.5 text-gray-400 text-sm'>OMR</span>
                        </div>
                    </div>
                ...
                <div className='mb-4 p-3 bg-gradient-to-r from-emerald-50 to-green-50 rounded-lg border border-emerald-100'>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <span className={`text-sm font-semibold ${Number(supplierData.balance) >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                            {Number(supplierData.balance || 0).toFixed(2)} OMR
                        </span>
                    </div>
                </div>
            )}
